...
[**Fibonacci Sequence**](https://github.com/aktaylor08/Projects/blob/master/Numbers/fib.py) – Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.

**Prime Factorization** – Have the user enter a number and find all Prime Factors (if there are any) and display them.

[**Next Prime Number**](https://github.com/aktaylor08/Projects/blob/master/Numbers/primes.py) – Have the program find prime numbers until the user chooses to stop asking for the next one.

[**Find Cost of Tile to Cover W x H Floor**](https://github.com/aktaylor08/Projects/blob/master/Numbers/cost.py) – Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.
...
[**Reverse a String**](https://github.com/aktaylor08/Projects/blob/master/text/reverse.py) – Enter a string and the program will reverse it and print it out.
